(() => {
    ...
    s.n = e => {
        ...
        var e = s(89),
            ...
            r = s(522),
            i = s(634);
        const c = JSON.parse('["sharon-dev\\\\.com(?:/.*)?/ola/services/.*","sharon-dev\\\\.com/ola/meetings/.*","/api/","https://api\\\\.ola\\\\.godaddy\\\\.com","https://f74cb90f-d8ed-4b9c-a741-b24e42bc7cd8\\\\.onlinestore\\\\.godaddy\\\\.com","/t/1/tl/event","google-analytics\\\\.com/collect","calendar\\\\.apps\\\\.(dev-|test-)?secureserver\\\\.net"]').map((e => new RegExp(e))),
            o = JSON.parse('["sharon-dev\\\\.com(?:/.*)?/f/.*","https://blog\\\\.apps\\\\.secureserver\\\\.net/v1/website/f74cb90f-d8ed-4b9c-a741-b24e42bc7cd8/feed/post/","https://blog\\\\.apps\\\\.secureserver\\\\.net/v1/website/f74cb90f-d8ed-4b9c-a741-b24e42bc7cd8/feed"]').map((e => new RegExp(e))),
            h = JSON.parse('["/"]').map((e => ({
                url: e,
                revision: "1711695327118"
            })));
        self.addEventListener("activate", (function(e) {
            e.waitUntil(caches.keys().then((function(e) {
                return Promise.all(e.filter((e => e.startsWith("sharon-dev.com-"))).map((e => caches.delete(e))))
            })))
